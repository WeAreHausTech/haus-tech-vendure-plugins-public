...
- [AI-assisted Development](https://docs.vendure.io/current/core/developer-guide/ai-assisted-development.md): AI-assisted Development
...
- [Toolbar Items](https://docs.vendure.io/current/core/extending-the-dashboard/customizing-pages/toolbar-items.md): Toolbar Items
- [Extension Targets](https://docs.vendure.io/current/core/extending-the-dashboard/customizing-pages/extension-targets.md): Extension Targets
...
- [Customizing Forms](https://docs.vendure.io/current/core/extending-the-dashboard/custom-form-components.md): Customizing Forms
- [Input Component Examples](https://docs.vendure.io/current/core/extending-the-dashboard/custom-form-components/form-component-examples.md): Input Component Examples
- [Relation Selector Components](https://docs.vendure.io/current/core/extending-the-dashboard/custom-form-components/relation-selectors.md): Relation Selector Components
...
- [Custom Providers](https://docs.vendure.io/current/core/extending-the-dashboard/custom-providers.md): Custom Providers
...
- [Deployment](https://docs.vendure.io/current/core/deployment.md): Deployment
...
- [CustomerChannelAssignmentStrategy](https://docs.vendure.io/current/core/reference/typescript-api/auth/customer-channel-assignment-strategy.md): CustomerChannelAssignmentStrategy
...
- [HealthCheckError](https://docs.vendure.io/current/core/reference/typescript-api/health-check/health-check-error.md): HealthCheckError
...
- [HealthIndicator](https://docs.vendure.io/current/core/reference/typescript-api/health-check/health-indicator.md): HealthIndicator
- [HealthIndicatorFunction](https://docs.vendure.io/current/core/reference/typescript-api/health-check/health-indicator-function.md): HealthIndicatorFunction
- [HealthIndicatorResult](https://docs.vendure.io/current/core/reference/typescript-api/health-check/health-indicator-result.md): HealthIndicatorResult
- [HealthIndicatorStatus](https://docs.vendure.io/current/core/reference/typescript-api/health-check/health-indicator-status.md): HealthIndicatorStatus
...
- [DefaultAssetImportStrategyOptions](https://docs.vendure.io/current/core/reference/typescript-api/import-export/default-asset-import-strategy-options.md): DefaultAssetImportStrategyOptions
...
- [OrderLineDiscountDistributionStrategy](https://docs.vendure.io/current/core/reference/typescript-api/orders/order-line-discount-distribution-strategy.md): OrderLineDiscountDistributionStrategy
...
- [CustomerChannelAssignmentService](https://docs.vendure.io/current/core/reference/typescript-api/services/customer-channel-assignment-service.md): CustomerChannelAssignmentService
...
- [Custom Providers](https://docs.vendure.io/current/core/reference/dashboard/extensions-api/custom-providers.md): Custom Providers
...
- [UseIsServerConfigLoaded](https://docs.vendure.io/current/core/reference/dashboard/hooks/use-is-server-config-loaded.md): UseIsServerConfigLoaded
