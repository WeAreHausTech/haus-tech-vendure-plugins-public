...
export type BadgeFilterParameter = {
  _and?: InputMaybe<Array<BadgeFilterParameter>>
  _or?: InputMaybe<Array<BadgeFilterParameter>>
...
export type BadgeList = PaginatedList & {
  __typename?: 'BadgeList'
  items: Array<Badge>
  totalItems: Scalars['Int']['output']
}

export type BadgeListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<BadgeFilterParameter>
  /** Specifies whether multiple top-level "filter" fields should be combined with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']['input']>
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<BadgeSortParameter>
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']['input']>
}

export type BadgePluginConfig = {
  __typename?: 'BadgePluginConfig'
  availablePositions?: Maybe<Array<Maybe<Scalars['String']['output']>>>
}

export type BadgeSortParameter = {
...
export type CollectionFilterParameter = {
  ...
  fullUrl?: InputMaybe<StringOperators>
  id?: InputMaybe<IdOperators>
...
export type CreateFeedConfigInput = {
  collectionId?: InputMaybe<Scalars['ID']['input']>
  countryCode: Scalars['String']['input']
  fieldMapping: Scalars['JSON']['input']
  generationSchedule?: InputMaybe<Scalars['String']['input']>
  languageCurrencyMapping: Scalars['JSON']['input']
  metaMapping?: InputMaybe<Scalars['JSON']['input']>
  name: Scalars['String']['input']
...
export type CreateProductCustomFieldsInput = {
  canNotBeInstalled?: InputMaybe<Scalars['Boolean']['input']>
  hideIoKPrice?: InputMaybe<Scalars['Boolean']['input']>
  hideOrdinaryPrice?: InputMaybe<Scalars['Boolean']['input']>
  metaDescription?: InputMaybe<Scalars['String']['input']>
  popularityInternal?: InputMaybe<Scalars['Int']['input']>
  shortDescription?: InputMaybe<Scalars['String']['input']>
  systemImageIds?: InputMaybe<Array<Scalars['ID']['input']>>
}
...
export type CreateProductVariantCustomFieldsInput = {
  ...
  energyLabel?: InputMaybe<Scalars['String']['input']>
  energyLabelImageId?: InputMaybe<Scalars['ID']['input']>
  gtin13_1?: InputMaybe<Scalars['String']['input']>
  leverantorsArtikelNr?: InputMaybe<Scalars['String']['input']>
  productSheetId?: InputMaybe<Scalars['ID']['input']>
  rskNumber?: InputMaybe<Scalars['String']['input']>
}
...
export type CreateProductVariantPriceCustomFieldsInput = {
  ahlsellPurchasePrice?: InputMaybe<Scalars['Int']['input']>
  dahlPurchasePrice?: InputMaybe<Scalars['Int']['input']>
  directPurchasePrice?: InputMaybe<Scalars['Int']['input']>
  iokOrdinaryPrice?: InputMaybe<Scalars['Int']['input']>
  ordinaryPrice?: InputMaybe<Scalars['Int']['input']>
  solarPurchasePrice?: InputMaybe<Scalars['Int']['input']>
}
...
export type CustomProductMappings = {
  ...
  canNotBeInstalled?: Maybe<Scalars['Boolean']['output']>
  energyLabel?: Maybe<Scalars['String']['output']>
  energyLabelImage?: Maybe<Scalars['String']['output']>
  facetValueName: Array<Scalars['String']['output']>
  featuredAsset?: Maybe<Scalars['String']['output']>
  featuredAssets: Scalars['String']['output']
  hideIoKPrice?: Maybe<Scalars['Boolean']['output']>
  hideOrdinaryPrice?: Maybe<Scalars['Boolean']['output']>
  priceIncludesROT?: Maybe<Scalars['Boolean']['output']>
  productSheet?: Maybe<Scalars['String']['output']>
  productVariantIds: Array<Scalars['ID']['output']>
  productVariantPrices: Scalars['String']['output']
  shortDescription?: Maybe<Scalars['String']['output']>
}

export type CustomProductVariantMappings = {
  __typename?: 'CustomProductVariantMappings'
  breadcrumb: Scalars['String']['output']
  excludeFromIndex?: Maybe<Scalars['Boolean']['output']>
  leverantorsArtikelNr: Scalars['String']['output']
  rskNumber: Scalars['String']['output']
}
...
export type FeedConfig = Node & {
  __typename?: 'FeedConfig'
  channels: Array<Channel>
  collection?: Maybe<Collection>
  countryCode: Scalars['String']['output']
  createdAt: Scalars['DateTime']['output']
  feedUrl?: Maybe<Scalars['String']['output']>
  fieldMapping: Scalars['JSON']['output']
  generationSchedule?: Maybe<Scalars['String']['output']>
  id: Scalars['ID']['output']
  languageCurrencyMapping: Scalars['JSON']['output']
  lastGeneratedAt?: Maybe<Scalars['DateTime']['output']>
  metaMapping?: Maybe<Scalars['JSON']['output']>
  name: Scalars['String']['output']
  targetService: TargetService
  updatedAt: Scalars['DateTime']['output']
}

export type FeedConfigFilterParameter = {
  _and?: InputMaybe<Array<FeedConfigFilterParameter>>
  _or?: InputMaybe<Array<FeedConfigFilterParameter>>
  countryCode?: InputMaybe<StringOperators>
  createdAt?: InputMaybe<DateOperators>
  feedUrl?: InputMaybe<StringOperators>
  generationSchedule?: InputMaybe<StringOperators>
  id?: InputMaybe<IdOperators>
  lastGeneratedAt?: InputMaybe<DateOperators>
  name?: InputMaybe<StringOperators>
  targetService?: InputMaybe<StringOperators>
  updatedAt?: InputMaybe<DateOperators>
}

export type FeedConfigList = PaginatedList & {
  __typename?: 'FeedConfigList'
  items: Array<FeedConfig>
  totalItems: Scalars['Int']['output']
}

export type FeedConfigListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<FeedConfigFilterParameter>
  /** Specifies whether multiple top-level "filter" fields should be combined with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']['input']>
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<FeedConfigSortParameter>
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']['input']>
}

export type FeedConfigSortParameter = {
  countryCode?: InputMaybe<SortOrder>
  createdAt?: InputMaybe<SortOrder>
  feedUrl?: InputMaybe<SortOrder>
  generationSchedule?: InputMaybe<SortOrder>
  id?: InputMaybe<SortOrder>
  lastGeneratedAt?: InputMaybe<SortOrder>
  name?: InputMaybe<SortOrder>
  updatedAt?: InputMaybe<SortOrder>
}

export type FeedGenerationResult = {
  __typename?: 'FeedGenerationResult'
  feedUrl: Scalars['String']['output']
  itemCount: Scalars['Int']['output']
  lastGeneratedAt: Scalars['DateTime']['output']
}

export type FeedLog = Node & {
  __typename?: 'FeedLog'
  action: FeedLogAction
  config: FeedConfig
  createdAt: Scalars['DateTime']['output']
...
export enum FeedLogAction {
  FEED_CHANGE = 'FEED_CHANGE',
  FEED_GENERATION = 'FEED_GENERATION',
}

export type FeedLogFilterParameter = {
  _and?: InputMaybe<Array<FeedLogFilterParameter>>
  _or?: InputMaybe<Array<FeedLogFilterParameter>>
...
export type FeedLogList = PaginatedList & {
  __typename?: 'FeedLogList'
  items: Array<FeedLog>
  totalItems: Scalars['Int']['output']
}

export type FeedLogListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<FeedLogFilterParameter>
  /** Specifies whether multiple top-level "filter" fields should be combined with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']['input']>
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<FeedLogSortParameter>
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']['input']>
}

export type FeedLogSortParameter = {
  createdAt?: InputMaybe<SortOrder>
...
export type Mutation = {
  ...
  createSynonymGroup: SynonymGroup
  /** Create a new Tag */
  createTag: Tag
  ...
  deleteFeedConfig: DeletionResponse
  ...
  deleteSynonymGroup: DeletionResponse
  ...
  logout: Success
  mapFeedConfigProducts: FeedGenerationResult
  /**
  ...
  updateSynonymGroup: SynonymGroup
...
export type MutationCreateFeedConfigArgs = {
  input: CreateFeedConfigInput
}
...
export type MutationDeleteFeedConfigArgs = {
  id: Scalars['ID']['input']
}
...
export type MutationMapFeedConfigProductsArgs = {
  feedConfigId: Scalars['ID']['input']
}
...
export type OrderCustomFields = {
  ...
  orderMessage?: Maybe<Scalars['String']['output']>
  ...
  storeEmailIok?: Maybe<Scalars['String']['output']>
  storeId?: Maybe<Scalars['String']['output']>
  storeMemberId?: Maybe<Scalars['String']['output']>
...
export type OrderFilterParameter = {
  ...
  code?: InputMaybe<StringOperators>
  companyRegistrationNumber?: InputMaybe<StringOperators>
  createdAt?: InputMaybe<DateOperators>
  currencyCode?: InputMaybe<StringOperators>
  customerLastName?: InputMaybe<StringOperators>
  id?: InputMaybe<IdOperators>
  orderMessage?: InputMaybe<StringOperators>
  orderPlacedAt?: InputMaybe<DateOperators>
  propertyDesignation?: InputMaybe<StringOperators>
  shipping?: InputMaybe<NumberOperators>
  shippingWithTax?: InputMaybe<NumberOperators>
  socialSecurityNumber?: InputMaybe<StringOperators>
  state?: InputMaybe<StringOperators>
  storeEmail?: InputMaybe<StringOperators>
  storeEmailIok?: InputMaybe<StringOperators>
  storeId?: InputMaybe<StringOperators>
  storeMemberId?: InputMaybe<StringOperators>
  storeName?: InputMaybe<StringOperators>
...
export type OrderSortParameter = {
  ...
  code?: InputMaybe<SortOrder>
  companyRegistrationNumber?: InputMaybe<SortOrder>
  createdAt?: InputMaybe<SortOrder>
  customerLastName?: InputMaybe<SortOrder>
  id?: InputMaybe<SortOrder>
  orderMessage?: InputMaybe<SortOrder>
  orderPlacedAt?: InputMaybe<SortOrder>
  propertyDesignation?: InputMaybe<SortOrder>
  shipping?: InputMaybe<SortOrder>
  shippingWithTax?: InputMaybe<SortOrder>
  socialSecurityNumber?: InputMaybe<SortOrder>
  state?: InputMaybe<SortOrder>
  storeEmail?: InputMaybe<SortOrder>
  storeEmailIok?: InputMaybe<SortOrder>
  storeId?: InputMaybe<SortOrder>
  storeMemberId?: InputMaybe<SortOrder>
  storeName?: InputMaybe<SortOrder>
...
export type ProductCustomFields = {
  ...
  popularityInternal?: Maybe<Scalars['Int']['output']>
  shortDescription?: Maybe<Scalars['String']['output']>
  systemImage?: Maybe<Array<Asset>>
}

export type ProductFilterParameter = {
  _and?: InputMaybe<Array<ProductFilterParameter>>
  _or?: InputMaybe<Array<ProductFilterParameter>>
  canNotBeInstalled?: InputMaybe<BooleanOperators>
  createdAt?: InputMaybe<DateOperators>
  description?: InputMaybe<StringOperators>
  enabled?: InputMaybe<BooleanOperators>
  facetValueId?: InputMaybe<IdOperators>
  fullUrl?: InputMaybe<StringOperators>
  hideIoKPrice?: InputMaybe<BooleanOperators>
  hideOrdinaryPrice?: InputMaybe<BooleanOperators>
  id?: InputMaybe<IdOperators>
  languageCode?: InputMaybe<StringOperators>
  metaDescription?: InputMaybe<StringOperators>
  name?: InputMaybe<StringOperators>
  popularityInternal?: InputMaybe<NumberOperators>
...
export type ProductSortParameter = {
  canNotBeInstalled?: InputMaybe<SortOrder>
  createdAt?: InputMaybe<SortOrder>
  description?: InputMaybe<SortOrder>
  fullUrl?: InputMaybe<SortOrder>
  hideIoKPrice?: InputMaybe<SortOrder>
  hideOrdinaryPrice?: InputMaybe<SortOrder>
  id?: InputMaybe<SortOrder>
  metaDescription?: InputMaybe<SortOrder>
  name?: InputMaybe<SortOrder>
  popularityInternal?: InputMaybe<SortOrder>
...
export type ProductVariantCustomFields = {
  ...
  energyLabel?: Maybe<Scalars['String']['output']>
  energyLabelImage?: Maybe<Asset>
  gtin13_1?: Maybe<Scalars['String']['output']>
  leverantorsArtikelNr?: Maybe<Scalars['String']['output']>
  productSheet?: Maybe<Asset>
  rskNumber?: Maybe<Scalars['String']['output']>
}

export type ProductVariantFilterParameter = {
  _and?: InputMaybe<Array<ProductVariantFilterParameter>>
  _or?: InputMaybe<Array<ProductVariantFilterParameter>>
  attributes?: InputMaybe<StringOperators>
  createdAt?: InputMaybe<DateOperators>
  currencyCode?: InputMaybe<StringOperators>
  enabled?: InputMaybe<BooleanOperators>
  energyLabel?: InputMaybe<StringOperators>
  facetValueId?: InputMaybe<IdOperators>
  gtin13_1?: InputMaybe<StringOperators>
  id?: InputMaybe<IdOperators>
  languageCode?: InputMaybe<StringOperators>
  leverantorsArtikelNr?: InputMaybe<StringOperators>
  name?: InputMaybe<StringOperators>
  outOfStockThreshold?: InputMaybe<NumberOperators>
  price?: InputMaybe<NumberOperators>
  priceWithTax?: InputMaybe<NumberOperators>
  productId?: InputMaybe<IdOperators>
  rskNumber?: InputMaybe<StringOperators>
  sku?: InputMaybe<StringOperators>
...
export type ProductVariantPriceCustomFields = {
  ...
  ahlsellPurchasePrice?: Maybe<Scalars['Int']['output']>
  dahlPurchasePrice?: Maybe<Scalars['Int']['output']>
  directPurchasePrice?: Maybe<Scalars['Int']['output']>
  iokOrdinaryPrice?: Maybe<Scalars['Int']['output']>
  ordinaryPrice?: Maybe<Scalars['Int']['output']>
  solarPurchasePrice?: Maybe<Scalars['Int']['output']>
}

export type ProductVariantSortParameter = {
  attributes?: InputMaybe<SortOrder>
  createdAt?: InputMaybe<SortOrder>
  energyLabel?: InputMaybe<SortOrder>
  energyLabelImage?: InputMaybe<SortOrder>
  gtin13_1?: InputMaybe<SortOrder>
  id?: InputMaybe<SortOrder>
  leverantorsArtikelNr?: InputMaybe<SortOrder>
  name?: InputMaybe<SortOrder>
  outOfStockThreshold?: InputMaybe<SortOrder>
  price?: InputMaybe<SortOrder>
  priceWithTax?: InputMaybe<SortOrder>
  productId?: InputMaybe<SortOrder>
  productSheet?: InputMaybe<SortOrder>
  rskNumber?: InputMaybe<SortOrder>
...
export type Query = {
  ...
  assets: AssetList
  availableFieldsForMapping: Array<AvailableField>
  badge?: Maybe<Badge>
  badges: BadgeList
  ...
  facets: FacetList
  feedConfig?: Maybe<FeedConfig>
  feedConfigs: FeedConfigList
  feedLogsByConfig: FeedLogList
  ...
  synonymGroup?: Maybe<SynonymGroup>
  synonymGroups: SynonymGroupList
  tag: Tag
  tags: TagList
...
export type QueryBadgesArgs = {
  options?: InputMaybe<BadgeListOptions>
}
...
export type QueryFeedConfigArgs = {
  id: Scalars['ID']['input']
}

export type QueryFeedConfigsArgs = {
  options?: InputMaybe<FeedConfigListOptions>
}

export type QueryFeedLogsByConfigArgs = {
  feedConfigId: Scalars['ID']['input']
  options?: InputMaybe<FeedLogListOptions>
}
...
export type QuerySynonymGroupArgs = {
  id: Scalars['ID']['input']
}

export type QuerySynonymGroupsArgs = {
  options?: InputMaybe<SynonymGroupListOptions>
}
...
export type SynonymGroupFilterParameter = {
  _and?: InputMaybe<Array<SynonymGroupFilterParameter>>
  _or?: InputMaybe<Array<SynonymGroupFilterParameter>>
  createdAt?: InputMaybe<DateOperators>
  id?: InputMaybe<IdOperators>
  languageCode?: InputMaybe<StringOperators>
  synonyms?: InputMaybe<StringOperators>
  updatedAt?: InputMaybe<DateOperators>
}

export type SynonymGroupList = PaginatedList & {
  __typename?: 'SynonymGroupList'
  items: Array<SynonymGroup>
  totalItems: Scalars['Int']['output']
}

export type SynonymGroupListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<SynonymGroupFilterParameter>
  /** Specifies whether multiple top-level "filter" fields should be combined with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']['input']>
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<SynonymGroupSortParameter>
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']['input']>
}

export type SynonymGroupSortParameter = {
  createdAt?: InputMaybe<SortOrder>
  id?: InputMaybe<SortOrder>
  updatedAt?: InputMaybe<SortOrder>
}
...
export type UpdateFeedConfigInput = {
  collectionId?: InputMaybe<Scalars['ID']['input']>
  countryCode?: InputMaybe<Scalars['String']['input']>
  fieldMapping?: InputMaybe<Scalars['JSON']['input']>
  generationSchedule?: InputMaybe<Scalars['String']['input']>
  id: Scalars['ID']['input']
  languageCurrencyMapping?: InputMaybe<Scalars['JSON']['input']>
  metaMapping?: InputMaybe<Scalars['JSON']['input']>
  name?: InputMaybe<Scalars['String']['input']>
  targetService?: InputMaybe<TargetService>
}

export type UpdateFeedLogInput = {
  action?: InputMaybe<FeedLogAction>
  finishedAt?: InputMaybe<Scalars['DateTime']['input']>
  id: Scalars['ID']['input']
  meta?: InputMaybe<Scalars['JSON']['input']>
  startedAt?: InputMaybe<Scalars['DateTime']['input']>
  status?: InputMaybe<FeedLogStatus>
}
...
export type UpdateOrderCustomFieldsInput = {
  ...
  orderMessage?: InputMaybe<Scalars['String']['input']>
...
export type SynonymGroupQueryVariables = Exact<{
  id: Scalars['ID']['input']
}>

export type SynonymGroupQuery = {
  __typename?: 'Query'
  synonymGroup?: {
    __typename?: 'SynonymGroup'
    id: string
...
export type CreateSynonymGroupMutationVariables = Exact<{
  input: CreateSynonymGroupInput
}>

export type CreateSynonymGroupMutation = {
  __typename?: 'Mutation'
  createSynonymGroup: { __typename?: 'SynonymGroup'; id: string }
}

export type UpdateSynonymGroupMutationVariables = Exact<{
  input: UpdateSynonymGroupInput
}>

export type UpdateSynonymGroupMutation = {
  __typename?: 'Mutation'
  updateSynonymGroup: { __typename?: 'SynonymGroup'; id: string }
}

export type DeleteSynonymGroupMutationVariables = Exact<{
  id: Scalars['ID']['input']
}>

export type DeleteSynonymGroupMutation = {
  __typename?: 'Mutation'
  deleteSynonymGroup: {
    __typename?: 'DeletionResponse'
    result: DeletionResult
...
export type SynonymGroupsQueryVariables = Exact<{
  options?: InputMaybe<SynonymGroupListOptions>
}>

export type SynonymGroupsQuery = {
  __typename?: 'Query'
  synonymGroups: {
    __typename?: 'SynonymGroupList'
    totalItems: number
...
export type DeleteSynonymGroupBulkMutationVariables = Exact<{
  id: Scalars['ID']['input']
}>

export type DeleteSynonymGroupBulkMutation = {
  __typename?: 'Mutation'
  deleteSynonymGroup: {
    __typename?: 'DeletionResponse'
    result: DeletionResult
...
export const SynonymGroupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SynonymGroup' },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<SynonymGroupQuery, SynonymGroupQueryVariables>
export const CreateSynonymGroupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateSynonymGroup' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateSynonymGroupInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<CreateSynonymGroupMutation, CreateSynonymGroupMutationVariables>
export const UpdateSynonymGroupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateSynonymGroup' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateSynonymGroupInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<UpdateSynonymGroupMutation, UpdateSynonymGroupMutationVariables>
export const DeleteSynonymGroupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'DeleteSynonymGroup' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<DeleteSynonymGroupMutation, DeleteSynonymGroupMutationVariables>
export const SynonymGroupsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SynonymGroups' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'options' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'SynonymGroupListOptions' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<SynonymGroupsQuery, SynonymGroupsQueryVariables>
export const DeleteSynonymGroupBulkDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'DeleteSynonymGroupBulk' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
  ...
  DeleteSynonymGroupBulkMutation,
  DeleteSynonymGroupBulkMutationVariables
>
