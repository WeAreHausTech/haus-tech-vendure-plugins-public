...
- Route by task (load one primary topic, not every file):
  - **Build / test locally** → [setup.md](setup.md)
...
- This is a **public** repository — never add customer names, internal hostnames, credentials, or internal-only process notes to these docs.
...
| File                               | Description                                                                                  |
| ---------------------------------- | -------------------------------------------------------------------------------------------- |
| [architecture.md](architecture.md) | How a Vendure plugin is structured here; Elasticsearch, object storage, and email boundaries |
...
| File                           | Description                                                        |
| ------------------------------ | ------------------------------------------------------------------ |
| [deployment.md](deployment.md) | Manual Nx Release to npm, version pinning, the docs-sync workflow |

## Decisions

| File                                     | Description                                       |
| ---------------------------------------- | ------------------------------------------------- |
| [decisions/README.md](decisions/README.md) | Architecture Decision Record index (empty today) |
